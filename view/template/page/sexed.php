...
<main>
  <div class="cover cover-dark cover-center cover-full cover--dark-overlay" style="background-image: url(/img/darkvenus.jpg)">
    <div class="content content-dark text-center">
      <h1 class="cover-title cover-title-tile cover-item--outline">YouTube is Afraid To Talk About Sex</h1>
      <h3 class="cover-item--outline">They've erased thousands of sexual education and sexual wellness videos. Have you had enough?</h3>
    </div>
