...
<main>
  <div class="cover cover-dark cover-center cover-full cover--dark-overlay" style="background-image: url(/img/clement-vit.jpg)">
    <div class="content content-dark text-center">
      <h1 class="cover-title cover-title-tile cover-item--outline">LBRY Welcomes E-Cell HackerTech 2018 Participants</h1>
      <h3 class="cover-item--outline">We're excited to meet the next generation of problem solvers!</h3>
