...
<main>
  <div class="cover cover-dark cover-center cover-full cover--dark-overlay" style="background-image: url(https://spee.ch/3/genius-chess-printed.jpeg)">
    <div class="content content-dark text-center">
      ...
      <h3 class="cover-item--outline"></h3>
  ...
  <div class="cover cover-light" id="about">
    <div class="content content-light content-readable">
      ...
      <p>
        You can <a href="/get?src=FA">download the LBRY app here.</a> If you have any questions or need help, <a href="http://chat.lbry.io">join our Discord community</a>.
      </p>
