...
<main>
  <div class="cover cover-dark cover-center cover-full cover--dark-overlay" style="background-image: url(/img/greens_mini.jpg)">
    <div class="content content-dark text-center">
      <h1 class="cover-title cover-title-tile cover-item--outline">YouTube Has Reefer Madness</h1>
      <h3 class="cover-item--outline">YouTube is erasing thousands of cannabis-related videos. Have you had enough?</h3>
    </div>
